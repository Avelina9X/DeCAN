...
def get_args( variant: str, exp_type: str | None = None, exp_init: str | None = None, smoothing: bool | None = None ):
    match variant:
        case 'mha':
            ...
            run_name = f'hexp{INIT_SEED}_Vanilla-MHA'
        ...
        case 'mqa':
            ...
            run_name = f'hexp{INIT_SEED}_Vanilla-MQA'
        ...
        case 'decan':
            ...
            run_name = f'hexp{INIT_SEED}_DeCAN'
        ...
        case 'decan+':
            ...
            run_name = f'hexp{INIT_SEED}_DeCAN_{exp_type}_{exp_init}'
            if smoothing:
                run_name += '_HS'
    ...
    args += [ '--model-kwargs', f'num_key_value_heads={num_key_value_heads}' ]
    ...
    args += [ '--manifest-file', f'runs{INIT_SEED}.yaml' ]
