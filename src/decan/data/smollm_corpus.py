...
class SmolLMCorpusClientDataset( IterableDataset ):
    ...
    def __init__(
        ...
        """ SmolLMCorpus iterable dataset for a single process on a single device.
...
class SmolLMCorpusDataset( IterableDataset ):
    """
    SmolLMCorpus IterableDataset which spawns multiple workers on a single device.
    ...
    def __init__(
        ...
        """ SmolLMCorpus iterable dataset for all processes on a single device.
    ...
    def create_worker( self, idx: int ) -> DataLoader:
        ...
        """
        return SmolLMCorpusClientDataset(
